...
Tops.pack(side=TOP);
f1=Frame(root,width=800,height=700,bg="#ffffff");
f1.pack(side=LEFT);
f2=Frame(root,width=300,height=700,bg="#ffffff");
f2.pack(side=RIGHT);
#=====================Time==============================
...
def Ref():
    ...
    CostofBurger=CoBurger*287
    CostChicken_Burger=CoChicBurger*289
    CostCheese_Burger=CoCheese_Burger*269
    CostOfMeal="Rupees:",str('%.2f'%(CostofFries+CostofDrinks+Costoffilet+CostofBurger+
    ...
    Service="Rupees:",str('%.2f'% Ser_Charge)
    OverAllCost="Rupees:",str('%.2f'% (PayTax+TotalCost+Ser_Charge))
    PaidTax="Rupees:",str('%.2f'% PayTax)
...
btn7=Button(f2,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),text="9",bg="powder blue",command=lambda:btnClick(9));
...
btnClear=Button(f2,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),text="C",bg="powder blue",command=btnClearDisplay);
btnClear.grid(row=5,column=1);

btnEqual=Button(f2,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),text="=",bg="powder blue",command=btnEqualsInput);
